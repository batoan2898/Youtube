...
class PlaylistAdapter(context: Context?, private val onClickListener: OnClickVideo) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        return YoutubeVideoHolder(inflater.inflate(R.layout.item_video, parent, false))
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        if (onClickListener != null) {
            if (video != null) {
                ...
                holder.itemView.imItemMenu.setOnClickListener {
